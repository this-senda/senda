...
export const ReadCollectionSecrets = method("ReadCollectionSecrets");
export const SaveCollectionSecrets = method("SaveCollectionSecrets");
export const ReadEnvironmentSecrets = method("ReadEnvironmentSecrets");
export const SaveEnvironmentSecrets = method("SaveEnvironmentSecrets");
export const EncryptionStatus = method("EncryptionStatus");
export const EnableEncryption = method("EnableEncryption");
export const DisableEncryption = method("DisableEncryption");
export const ExportKey = method("ExportKey");
export const ImportKey = method("ImportKey");
...
export const ListSpecs = method("ListSpecs");
export const ReadSpec = method("ReadSpec");
export const WriteSpec = method("WriteSpec");
export const ValidateSpec = method("ValidateSpec");
export const SpecOperations = method("SpecOperations");
export const SpecOperationDetail = method("SpecOperationDetail");
export const UpdateSpecOperation = method("UpdateSpecOperation");
export const RequestBodySchema = method("RequestBodySchema");
export const ValidateJSONSchema = method("ValidateJSONSchema");
